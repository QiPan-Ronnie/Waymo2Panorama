"""Strip emojis to text equivalents + render Week-2 mid-week handoff MD to PDF via pandoc+xelatex.

Adapted from _render_pdf_w2.py for the W2 mid-week (T-Koi-2) handoff.
"""
import subprocess
import sys
...
SRC = HERE / "handoff_to_koi_w2_2026-05-21_mid.md"
TMP = HERE / "handoff_to_koi_w2_2026-05-21_mid.print.md"
PDF = HERE / "handoff_to_koi_w2_2026-05-21_mid.pdf"
