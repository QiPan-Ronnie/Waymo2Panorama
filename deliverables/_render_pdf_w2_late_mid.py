"""Strip emojis to text equivalents + render Week-2 late-mid (Wave-3 wrap) handoff MD to PDF via pandoc+xelatex.

Adapted from _render_pdf_w2_mid.py for the W2 late-mid (T-Koi-3) handoff.
"""
import subprocess
import sys
...
SRC = HERE / "handoff_to_koi_w2_2026-05-21_late_mid.md"
TMP = HERE / "handoff_to_koi_w2_2026-05-21_late_mid.print.md"
PDF = HERE / "handoff_to_koi_w2_2026-05-21_late_mid.pdf"
