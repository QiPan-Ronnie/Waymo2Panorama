"""Strip emojis to text equivalents + render v6.1 mid-CPU-wave (T-Koi-4) handoff MD to PDF via pandoc+xelatex.

Adapted from _render_pdf_w2_late_mid.py for the v6.1 mid-CPU-wave (T-Koi-4) snapshot.
"""
import subprocess
import sys
...
SRC = HERE / "handoff_to_koi_w2_2026-05-21_v6cpu_done.md"
TMP = HERE / "handoff_to_koi_w2_2026-05-21_v6cpu_done.print.md"
PDF = HERE / "handoff_to_koi_w2_2026-05-21_v6cpu_done.pdf"
