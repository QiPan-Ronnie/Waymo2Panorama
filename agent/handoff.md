...
**Updated**: 2026-05-28 (Latest: dense Depth Anything V2 edge metadata was tested after LiDAR depth-visibility, sparse stereo v5, semantic object-coherent hard_select, same-frame/temporal ground-plane replacement, DiT360 v14, region-coherent seam v3a/v3b, and DiT-as-oracle source selection. Depth is POS as seam-risk metadata but weak NEG as a repair: LiDAR flags near/unknown/high-parallax seam strips, DA-V2 adds dense boundary cues, but neither chooses the correct camera or aligns geometry. Risk-gated local Y repair remains the stable POS optional polish.)
