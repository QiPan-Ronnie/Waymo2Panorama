...
**Updated**: 2026-05-28 (Latest: semantic object-coherent hard_select was tested after same-frame/temporal ground-plane replacement, DiT360 v14, region-coherent seam v3a/v3b, and DiT-as-oracle source selection. It is weak MIXED / mostly NEG: COCO instance masks protect only a small fraction of seam pixels and do not fix road/facade/lane mixed-depth seams. Moving/changing the source seam, one-plane replacement, and object-mask-only repair are now near exhausted. Risk-gated local Y repair remains the stable POS optional polish.)
