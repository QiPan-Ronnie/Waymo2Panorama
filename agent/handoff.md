...
**Updated**: 2026-05-28 (Latest: sparse stereo v5 was externally validated on a YOLO-selected ghosty fbee anchor after semantic object-coherent hard_select, same-frame/temporal ground-plane replacement, DiT360 v14, region-coherent seam v3a/v3b, and DiT-as-oracle source selection. It is NEG: stereo anchors are too sparse and A2v5 barely changes overlap alignment. Moving/changing the source seam, sparse displacement, one-plane replacement, and object-mask-only repair are now near exhausted. Risk-gated local Y repair remains the stable POS optional polish.)
