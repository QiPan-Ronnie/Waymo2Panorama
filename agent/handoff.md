...
**Updated**: 2026-05-28 (Latest: RGB+DA-V2 superpixel source coherence was tested after dense-depth-aware DP seam routing, dense Depth Anything V2 metadata, LiDAR depth-visibility, sparse stereo v5, semantic object-coherent hard_select, same-frame/temporal ground-plane replacement, DiT360 v14, region-coherent seam v3a/v3b, and DiT-as-oracle source selection. It is NEG: larger region units reduce seam dY but create blocky source swaps and drop source-fidelity NCC. Depth remains useful as seam-risk metadata, not as a local seam/source-selection solver. Risk-gated local Y repair remains the stable POS optional polish.)
