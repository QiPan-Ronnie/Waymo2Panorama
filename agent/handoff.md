...
**Updated**: 2026-05-28 (Latest: DiT360 v14 tri-map latent clamp was tested after region-coherent seam v3a/v3b and DiT-as-oracle source selection. It does not beat L1 hard_select: raw outputs smooth seams by rewriting evidence; faithful compose reverts toward hard_select. Moving/changing the source seam is now near exhausted. Risk-gated local Y repair remains the stable POS optional polish.)
