...
**Updated**: 2026-05-28 (Latest: DiT360 v12/v13 residual-multiband and Poisson/gradient-domain gated composition pushed the generative route to its practical limit. It reduces raw preserve MAE from ~4-5 to <=0.28, but visual gains remain cosmetic: safe variants revert toward hard_select, loose variants blur/smear geometry. Risk-gated local Y repair remains the stable POS optional polish.)
