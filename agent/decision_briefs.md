...
Status: ACTIVE (2026-06-19) — user found it in the MIDDLE-ONLY highway video (so it is NOT a ground-outpaint defect — it is in the scene-band STITCH). Audit-first.
