...
Status: A0 NEG/MIXED → A1 FULL pipeline BUILT+TESTED (2026-06-02) → **Route A ceiling ≈ L1+; does NOT single near-object doubling** → decision: pivot to DB-02/03 OR accept A1_core/E1.5
