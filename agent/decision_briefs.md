...
Status: FIX VALIDATED / SHIPPING (2026-06-19). Full arc done: audit → root-cause → isolation-NEG → scope sweep → fix → 3-condition validation; temporal regression running, then flip default ON.
