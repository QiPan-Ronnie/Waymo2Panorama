...
Status: A0 DONE (POS, 2026-06-02) → A1 NEXT
A0 result: POS/GO — coarse-plane DIBR raises seam-agreement NCC to 0.884 on the doubling band (L1 rot-only 0.822; per-pixel-LiDAR/E2 0.841), vision-clean with NO smear (E2 smears). Beats both single-center AND per-pixel. Full facts: `progress.md` 2026-06-02 A0 entry; figs `deliverables/a0_plane_dibr_probe/`.
