...
> **Status:** redesign done, single-source confirmed on BMW. NEXT (in progress): self code-review of the align code + validate 0bae/fbee + (research to-try) graph-cut seam routing & LiDAR-depth foreground-select for the residual large-parallax objects. **Locations:** GitHub committed (this commit); Drive `results/a1_streetview_pipeline/`.
> ---
