...
> **Status:** clean unification of the 3 ground modes (fill=texture / bev=coherence / bevdirect=both). Making it the ground DEFAULT is a fill-vs-bev policy choice (DB-94 Cosmos contract). NEXT optional: confirm on a radial-worst frame.
> ---
