...
> **Status:** decisive ceiling proof recorded. NEXT (testing, A100): the one remaining "beat-L1-cleanly" shot = confidence-gated learned-single-centre (DrivingForward) ⊕ L1 — de-double where 3DGS is clean, sharp L1 where it shreds. If that doesn't clearly beat L1, the wall is triple-confirmed → bring the honest verdict to the user. **Locations:** GitHub committing; Drive `results/killtest/`.
> ---
