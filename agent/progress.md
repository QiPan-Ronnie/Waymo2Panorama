...
> 📑 **Docs index**: E0/E1 archive `agent/experiments/2026-05-29-E0-ruler-and-E1-seam-fusion.md` · diffusion-sprint `agent/EXPLORATION-seam-synthesis-sprint.md` · paper sparks (20 papers) `agent/BRAINSTORM-2026-05-30-paper-sparks.md` · auto-plan candidate `agent/PLAN-plausible-360-synthesis.md` · **user discussion package `agent/方向讨论_2026-05-30/` (00_方向总览.md + 方法与论文_汇总.xlsx)** · handoff for parallel agent `agent/HANDOFF-PROMPT-for-other-agent-2026-05-30.md`.
