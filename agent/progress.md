...
> **CAUTION (memory v3j): self-occ-OFF is NOT shippable — the gate was tuned to stop downtown hood pollution. NEXT: verify generality (bmw/clean self-occ off vs on — clean-coverage up + NO hood smear?) → then a REFINED (less-conservative-but-principled) box, not fully off.**
> ---
