...
> **STATUS:** fix implemented + validated on the worst + a mild case; default still OFF (core caution). NEXT to ship: flip default ON + a FULL 93-frame video regression on the 4 scenes (scrub for any new artifact / moving-car intactness) before committing it as the new baseline. Commits 9424bdf (a309 win) + this. Evidence: `agent/_db103/AB_a309car_baseline_vs_flow.png`, `AB_crowd_a50_changed.png`.
