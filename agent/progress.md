...
> **NEXT (needs a Colab runtime): (1) fix #1 / #5 / #7; (2) FAITHFULLY implement Surround360 novel-view synthesis** (per-azimuth: warp LEFT by flow·t + RIGHT by flow·(1−t) to the in-between viewpoint, with FB-consistency gating + spatial-propagation flow); (3) re-run, VISION-judge. THEN re-decide Route A. Review = workflow `wf_45d55048-a81` (41 agents). Locations — GitHub committed.
> ---
